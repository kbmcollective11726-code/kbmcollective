-- =============================================================================
-- Admin web: B2B feedback list RPC (fixes "Could not find get_event_b2b_feedback")
-- =============================================================================
-- Run in Supabase Dashboard → SQL Editor → New query → Paste → Run.
-- Requires: b2b_meeting_feedback table, meeting_bookings, meeting_slots,
--           vendor_booths, users, is_event_admin(), is_platform_admin().
-- If b2b_meeting_feedback is missing, run RUN-B2B-AND-FEEDBACK-MIGRATIONS.sql first.
-- =============================================================================
